...
<div class="card">
    <div class="card-header">
        <a href="{{ url('surat_keluar/create') }}" class="btn btn-primary">Buat Surat Keluar</a>
    </div>
    <div class="card-body">
        <table class="table">
            <thead>
            ...
            @foreach ($surat_keluar as $value)
                <tr>
                    ...
                    <td><span class="badge rounded-pill text-bg-warning">{{ $value->statusTerakhir->status }}</span></td>
                    <td>
                        <div class="dropdown">
